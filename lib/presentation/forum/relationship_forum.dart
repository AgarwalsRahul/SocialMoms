...
class RelationshipForums extends StatefulWidget {
  ...
  @override
  _RelationshipForumsState createState() => _RelationshipForumsState();
}

class _RelationshipForumsState extends State<RelationshipForums> {
  ...
  void initState() {
    if (!_controller.isClosed || !_controller.isPaused) {
      Future.delayed(Duration.zero).then((_) async {
        return _controller
            .add((await widget.provider.retrieveRelationshipPosts()));
      });
    }
